...
public class SharedHelper {
    ...
    public static final String LOGIN_TYPE_DEEPLINK = "LOGIN_TYPE_DEEPLINK";
    public static final String LOGIN_TYPE_COGNITO = "LOGIN_TYPE_COGNITO";
    private static final String INVITE_LINK_KEY = "INVITE_LINK_KEY";
